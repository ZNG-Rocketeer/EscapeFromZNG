...
<body onload="chronoStart()">
  ...
  <div class="zng-center zng-margin-top">
    <div class="zng-solo">
      <div class="zng-card" >
        <h2>Enigme 2 <span id="Enisuiv" class="zng-hidden">2</span></h2>
        <p class="enigme">
