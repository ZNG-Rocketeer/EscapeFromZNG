...
<body onload=
<?php if (isset($_GET['zanga']) ) { if($_GET['zanga']=="esportteamXxxXtwitterfacebook"){
  echo "\"chronoStart();finEnigme(0);\"";
}else{
  echo "\"chronoStart()\"";
}
}
...
if (!isset($_GET['zanga'])){
  ...
  document.location.href=\"?zanga=esportteamXxeffacemoixXtwitterfacebook\"
  </script>";
}?>
...
<div class="zng-center zng-margin-top">
  <div class="zng-solo">
    <div class="zng-card" >
      <h2>Enigme 5 <span id="Enisuiv" class="zng-hidden">0</span></h2>
      <p class="enigme">
